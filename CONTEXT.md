...
Este arquivo consolida o contexto operacional extraído da transcrição da reunião inicial do projeto BIOQAV. Deve ser usado como ponto de partida por agentes que forem pesquisar, preparar apresentações, organizar contatos, estruturar propostas ou acompanhar a oportunidade.

**Fonte primária desta consolidação:** `reuniao_inicial.md`.

**Cuidado de interpretação:** a transcrição não possui diarização por participante, data, horário completo, duração ou ata aprovada. Portanto, este documento separa fatos relatados, propostas e pontos a confirmar. Não tratar hipóteses da reunião como fatos contratuais, técnicos ou comerciais sem validação documental.
...
## 4. Informações técnicas e comerciais relatadas — validar antes de reutilizar

### 4.1 Projeto e contratação
...
### 4.3 Processo e equipamentos

O fluxograma apresentado na reunião foi descrito como uma representação geral de processo para produção de bioQAV, e não necessariamente como o processo definitivo da Petrobras ou do EPC. A lista de equipamentos também foi apresentada como uma primeira estimativa, sujeita ao desenvolvimento do projetista.

Antes de montar uma proposta, obter:

1. fluxograma de processo adotado pelo EPC;
2. lista de equipamentos e limites de fornecimento;
3. requisitos de materiais, projeto, fabricação, inspeção e documentação;
4. critérios de pré-qualificação e aprovação de fornecedores;
5. cronograma de engenharia, compras, fabricação, inspeção, entrega e montagem;
6. requisitos de conteúdo local, logística, impostos e garantia;
7. canal formal para recebimento de documentos e dúvidas técnicas.

## 5. Modelo de atuação discutido

O fluxo de trabalho sugerido na reunião foi:

1. formalizar a relação entre as empresas e a WCE;
2. preparar uma apresentação institucional/técnica da WCE em português e inglês;
3. Leonardo fazer a aproximação com orçamento/suprimentos/engenharia do EPC;
4. Paulo conduzir a interface técnica brasileira e a tropicalização da solução;
5. Mateus conectar a equipe brasileira à WCE e apoiar a obtenção de dados na China;
6. Pedro coordenar a articulação comercial e o suporte brasileiro com Paulo;
7. realizar uma reunião técnica entre WCE, PSA-X, R2 e o EPC;
8. transformar a oportunidade em pacotes de equipamentos ou solução tecnológica compatíveis com o processo e com o orçamento do EPC.

### Limites de papel e compliance

Mateus informou que, por sua relação com a NOV, não deveria ser o líder da discussão técnica/comercial com o EPC. A comunicação deve respeitar as políticas da NOV, evitar conflito de interesse e manter rastreabilidade em canais autorizados. Antes de qualquer contato em nome da NOV, WCE, PSA-X ou R2, confirmar autorização, identidade da entidade que está falando e escopo de representação.

Não enviar proposta, compromisso de preço, promessa de exclusividade, material confidencial ou declaração sobre qualificação de fornecedor sem aprovação dos responsáveis legais/comerciais e sem documentação de suporte.
...
1. Começar por este arquivo e pela fonte `reuniao_inicial.md`.
2. Manter uma tabela separando **confirmado**, **relatado**, **proposto** e **pendente de validação**.
3. Não completar siglas, nomes jurídicos, valores, datas ou locais por inferência.
4. Confirmar por escrito decisões comerciais e contratuais antes de tratá-las como definitivas.
5. Usar somente canais oficiais autorizados para falar com WCE, NOV, PSA-X, R2 e o EPC.
6. Registrar cada contato, documento recebido, versão de apresentação e decisão.
7. Não enviar proposta externa sem revisão de escopo, preço, impostos, prazo, responsabilidade técnica e compliance.
8. Preservar este contexto e atualizar apenas com novos fatos documentados, mantendo o histórico das alterações.

## 10. Estado inicial resumido

**Status:** oportunidade em prospecção, sem contrato final confirmado e sem escopo técnico fechado.

**Objetivo imediato:** formalizar a relação entre os participantes, validar a oportunidade com o EPC e preparar uma apresentação técnica/comercial da WCE para identificar pacotes de fornecimento no projeto BIOQAV.

**Maior risco:** avançar comercialmente com nomes, escopos, percentuais ou canais não autorizados, especialmente por causa da relação de Mateus com a NOV e da incerteza sobre as entidades WCE/WCR e Tenenge/Tenente.
